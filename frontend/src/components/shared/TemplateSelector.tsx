...
const presetTemplates = [
  { id: '1', name: '國泰黃', preview: '/templates/template_1.png' },
  { id: '2', name: '國泰綠', preview: '/templates/template_2.png' },
  { id: '3', name: '國泰黃綠', preview: '/templates/template_3.png' },
  { id: '4', name: '海邊', preview: '/templates/template_4.png' },
  { id: '5', name: '商務', preview: '/templates/template_5.png' },
  { id: '6', name: '復古捲軸', preview: '/templates/template_y.png' },
  { id: '7', name: '矢量插畫', preview: '/templates/template_vector_illustration.png' },
  { id: '8', name: '擬物玻璃', preview: '/templates/template_glass.png' },
  
  { id: '9', name: '科技藍', preview: '/templates/template_b.png' },
  { id: '10', name: '簡約商務', preview: '/templates/template_s.png' },
  { id: '11', name: '學術報告', preview: '/templates/template_academic.jpg' },
];
...
export const TemplateSelector: React.FC<TemplateSelectorProps> = ({
  ...
  const [saveToLibrary, setSaveToLibrary] = useState(true); // 上傳模板時是否保存到模板庫（預設勾選）
  ...
  const handleDeleteUserTemplate = async (template: UserTemplate, e: React.MouseEvent) => {
    ...
    if (selectedTemplateId === template.template_id) {
      show({ message: '目前使用中的模板無法刪除，請先取消選擇或切換', type: 'info' });
      return;
    }
